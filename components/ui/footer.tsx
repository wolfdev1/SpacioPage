        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Spacio is an open-source project and the use of the code is free and legal. We want to collaborate with open source so that many people can collaborate with the project.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="https://github.com/wolfdev1/Spacio" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Spacio Discord Bot</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="https://github.com/wolfdev1/SpacioPage" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Spacio Page</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="https://github.com/wolfdev1/SpacioResources" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Spacio Resources</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Page desing by Cruip.com</div>
